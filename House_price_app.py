# -*- coding: utf-8 -*-
"""
Created on Fri Oct 31 09:51:13 2022
...
house_data = pd.read_csv('DC_house_data.csv', encoding = 'ISO-8859-1' )
...
html_temp = """
    <div style = "background - color: #483D8B; padding: 5px">
    <h3 style="color:#666666;text-align:left; line-height: 1.5">
    <p> <b> Choose input parameters by clicking the arrow on the Top left Corner display tthe input slider widget. </b><br/ >
...
def user_input_parameters():         
    bedrooms = st.sidebar.slider("1. No of bedrooms?", 0, 15, 4)      
...
url = '[SOURCE CODE](https://github.com/jajupeter/Web-App-DC-House-Price)'
